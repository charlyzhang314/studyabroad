...
<head>
    ...
    <link rel="stylesheet" href="app.css?29">
    <style type="text/css">
    	...
    	.state_pop{position: fixed;width: 100%;height: 100%;left: 0;top: 0;display: none;background: rgba(0, 0, 0, 0.6);}
    	.state_pop .inner{position: absolute;left: 50%;top: 50%;transform: translate(-50%,-50%);width: 74%}
    	.state_pop .inner .back{display: block;width: 100%}
    	.state_pop .inner .close_btn{position: absolute;left: 0;bottom: 0;width: 100%;height: 40%;}
...
<body class="bankspage interest">
	...
	<div class="state_pop">
		<div class="inner">
			<img src="../img/state-pop1.png" class="back" />
	...
	<?php
	if(isset($_GET['bank']) && ($_GET['bank'] == "boc" || $_GET['bank'] == "ph" || $_GET['bank'] == "gh" || $_GET['bank'] == "jh")){
	?>
	<script type="text/javascript" src="//policy.cookiereports.com/951e3a35_panel-zh-cn.js"></script>
	<?php
	}
	?>
	...
	?>
	<script type="text/javascript" src="../js/interest-bank-boc.js?v=323"></script>
	<?php
	}else if((isset($_GET['bank']) && ($_GET['bank'] == "jx") ) ||
		(isset($_GET['bankid']) && ($_GET['bankid'] == "bocom") )
	){
	?>
	<script type="text/javascript" src="../js/interest-bank-jh.js?v=323"></script>
	<?php
	}else if((isset($_GET['bank']) && ($_GET['bank'] == "bob") ) ||
		(isset($_GET['bankid']) && ($_GET['bankid'] == "bob") )
	){
	?>
	<script type="text/javascript" src="../js/interest-bank-bob.js?v=323"></script>
	<?php
	}else{
	?>
	<script type="text/javascript" src="../js/interest-bank.js?v=323"></script>
	<?php
	}
	?>
	<script type="text/javascript" src="../js/banks.js?321"></script>
	<script type="text/javascript" src="../js/cards2.js?321"></script>
	<script type="text/javascript">
 ...
 //    }
	...
	$(function(){
		if(hcmBankName == "boc" || hcmBankId == "boc"){	
    		$(".state_pop").show()
    	}

    	if(hcmBankName == "xdf" || hcmBankId == "xdf"){	
    		$("html").html("")
    	}
		...
		$(".state_pop .inner .close_btn").click(function(){
			$(".state_pop").fadeOut(300)
		})
            ...
            if(pic){
            	if(scroll == "1"){
            		popSwiper.appendSlide("<div class='swiper-slide'><div class='grid'>\
            						...
            						<a class='apply_btn' data-name='" + name + "' data-id='" + id + "' href='" + link + "'></a>\
            					</div></div>");
            	}else{
            		popSwiper.appendSlide("<div class='swiper-slide'><div class='grid'>\
            						<img src='../img/credit_card/" + pic + "' class='bg' />\
   ...
   //      })
        ...
        $(document).on("click", ".item.interest.btn-interest", function (e) {
	    	...
	    	location.href = link + "?bank=" + bankName + "&stage_type=" + stageType + "&country_type=" + countryType + "&tag_age_name=" + tagAgeName + "&tag_stage_name=" + tagStageName + "&isBank=" + isBank;
	    });
	});
	</script>
