...
if(is_weixin_visit() && empty($openid)){
    $callback = "https://digitas.yijiuplus.com/studyabroad/index.php";
...
<body class="index" style="background: white;border-top: none;">
    <img class="sharing_img" src="img/visa_sharing_img.jpg" />

    <div class="container-fluid px-0 loading">
        <div class="d-flex flex-column justify-content-center text-center" style="border-top: none;">
            <img src="img/logo_visa.png" width="120" alt="Visa Logo" />
	...
	$(function(){
		//initIndex();
        var hash = getCookie(C_LAST_INTEREST);
        if (hash) {
            replaceLocWithDelay("interest.php#"+hash, 2000);
            return;
        }else{
            replaceLocWithDelay("interest.php#parent-uk-pretrip", 2000);
        }
	});
	</script>
